            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="content style text-center">
                        ...
                        <a href="<?php url('about-us');?>" class="btn btn-main btn-white" data-animation-in="slideInLeft" data-duration-in="1.2">explore</a>
                    </div>
                    <!-- Slide Content End -->
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="content style text-center">
                        ...
                        <a href="<?php url('about-us');?>" class="btn btn-main btn-white" data-animation-in="slideInRight" data-duration-in="1.2">about us</a>
                    </div>
                    <!-- Slide Content End-->
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="content text-center style">
                        ...
                        <a href="<?php url('about-us');?>" class="btn btn-main btn-white" data-animation-in="slideInRight" data-duration-in="1.2">shop now</a>
                    </div>
                    <!-- Slide Content End -->
                </div>
            </div>
